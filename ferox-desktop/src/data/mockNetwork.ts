...
export type NodeType = 'attacker' | 'target' | 'compromised' | 'server' | 'router' | 'workstation';
export type NodeStatus = 'active' | 'idle' | 'scanning' | 'exploited' | 'offline';
...
export const mockEdges: NetworkEdge[] = [
  ...
  { id: 'e7', from: 'ws1', to: 'target', type: 'exfil', active: true, bandwidth: 75 },
];
