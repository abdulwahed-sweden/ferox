...
import type { NetworkEdge as EdgeType, NetworkNode } from '../../data/mockNetwork';
...
export function NetworkEdge({ edge, nodes, containerWidth, containerHeight }: NetworkEdgeProps) {
