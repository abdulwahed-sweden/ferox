...
export function AmsiEtwPanel() {
  ...
  const [etwProviders, setEtwProviders] = useState<string[]>([
    "PowerShell",
    "DotNet",
  ]);
      ...
      <div className="bg-warning-soft border border-yellow-400/30 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-text-secondary mt-1">
              These bypasses modify system behavior and may be detected by
              advanced EDR solutions. Use appropriate stealth level and verify
